...
urlpatterns = [
    ...
    url(r'^Predict_Hourly_Boarding_Demand_Type/$', remoteuser.Predict_Hourly_Boarding_Demand_Type, name="Predict_Hourly_Boarding_Demand_Type"),
    ...
    url(r'^View_Predicted_Hourly_Boarding_Demand_Type_Ratio/$', serviceprovider.View_Predicted_Hourly_Boarding_Demand_Type_Ratio, name="View_Predicted_Hourly_Boarding_Demand_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Predicted_Hourly_Boarding_Demand_Type/$', serviceprovider.View_Predicted_Hourly_Boarding_Demand_Type, name="View_Predicted_Hourly_Boarding_Demand_Type"),
